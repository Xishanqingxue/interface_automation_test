...
#     httpType = models.CharField(max_length=50, default='HTTP', verbose_name='http/https', choices=(
#         ('HTTP', 'HTTP'),
#         ('HTTPS', 'HTTPS')
#     ))
#     requestType = models.CharField(max_length=50, verbose_name='请求方式', choices=(
#         ('POST', 'POST'),
#         ('GET', 'GET'),
#         ('PUT', 'PUT'),
#         ('DELETE', 'DELETE')
...
#     requestParameterType = models.CharField(max_length=50, verbose_name='请求参数格式', choices=(
...
#     type = models.CharField(default="String", max_length=1024, verbose_name='参数类型',
...
#     ))
#     apiAddress = models.CharField(max_length=1024, verbose_name='接口地址')
#     requestParameterType = models.CharField(max_length=50, verbose_name='参数请求格式', choices=(
#         ('form-data', '表单(form-data)'),
#         ('raw', '源数据(raw)'),
#         ('Restful', 'Restful')
#     ))
#     examineType = models.CharField(default='no_check', max_length=50, verbose_name='校验方式', choices=(
#         ('no_check', '不校验'),
...
#         ('Regular_check', '正则校验'),
#     ))
#     httpCode = models.CharField(max_length=50, blank=True, null=True, verbose_name='HTTP状态', choices=(
#         ('200', '200'),
#         ('404', '404'),
#         ('400', '400'),
#         ('502', '502'),
...
#     requestType = models.CharField(max_length=1024, verbose_name='请求方式', choices=(
#         ('POST', 'POST'),
#         ('GET', 'GET'),
#         ('PUT', 'PUT'),
#         ('DELETE', 'DELETE')
...
#     statusCode = models.CharField(blank=True, null=True, max_length=1024, verbose_name='期望HTTP状态', choices=(
#         ('200', '200'),
#         ('404', '404'),
#         ('400', '400'),
#         ('502', '502'),
...
#     result = models.CharField(max_length=50, verbose_name='测试结果', choices=(
#         ('PASS', '成功'),
#         ('FAIL', '失败'),
#     ))
#     httpStatus = models.CharField(max_length=50, blank=True, null=True, verbose_name='http状态', choices=(
#         ('200', '200'),
#         ('404', '404'),
#         ('400', '400'),
#         ('502', '502'),
...
#     type = models.CharField(max_length=50, verbose_name='类型', choices=(
#         ('circulation', '循环'),
#         ('timing', '定时'),
#     ))
#     frequency = models.IntegerField(blank=True, null=True, verbose_name='间隔')
#     unit = models.CharField(max_length=50, blank=True, null=True, verbose_name='单位', choices=(
#         ('m', '分'),
#         ('h', '时'),
#         ('d', '天'),
#         ('w', '周'),
